...
public class AppRater {
    ...
    public static class Builder {
        ...
        public Builder daysUntilPrompt(int daysUntilPrompt) {
            this.daysUntilPromptForRemindLater = daysUntilPrompt;
            return this;
        }

        public Builder launchesUntilPrompt(int launchesUntilPrompt) {
            this.launchesUntilPromptForRemindLater = launchesUntilPrompt;
            return this;
        }
        ...
        public Builder isVersionNameCheckEnabled(boolean isVersionNameCheckEnabled) {
            this.isVersionNameCheckEnabled = isVersionNameCheckEnabled;
            return this;
        }

        public Builder isVersionCodeCheckEnabled(boolean isVersionCodeCheckEnabled) {
    ...
    private AppRater(Builder builder) {
        daysUntilPromptForRemindLater = builder.daysUntilPromptForRemindLater;
        launchesUntilPromptForRemindLater = builder.launchesUntilPromptForRemindLater;
        isDark = builder.isDark;
        themeSet = builder.themeSet;
        hideNoButton = builder.hideNoButton;
        isVersionNameCheckEnabled = builder.isVersionNameCheckEnabled;
        isVersionCodeCheckEnabled = builder.isVersionCodeCheckEnabled;
    ...
    public void rateNow() {
        try {
            Intent rateNowIntent = new Intent(Intent.ACTION_VIEW, market.getMarketURI(mContext));
            mContext.startActivity(rateNowIntent);
